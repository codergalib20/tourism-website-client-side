...
const DetailsService = () => {
    ...
    return (
        <div className="py-10">
           ...
           <div className="lg:col-span-2 px-3 py-5 lg:py-0">
               ...
               <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <input className="border-2 py-2 px-3 cursor-pointer bg-yellow-900 hover:bg-yellow-50 text-yellow-50 hover:text-yellow-900 border-yellow-900 smooth-animation" type="submit" value="Order"/>
                </form>
           </div>
        </div>
        </div>
